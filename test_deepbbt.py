...
parser.add_argument("--task_name", default='AGNews', type=str, help='[SST-2, Yelp, AGNews, TREC, MRPC, SNLI]')
# parser.add_argument("--seed", default=8, type=int)
parser.add_argument("--device", default='cuda:2', type=str)
parser.add_argument("--offline", default=True, action='store_true', help='for transformers offline')
parser.add_argument("--instruction", default=True, action='store_true', help='for instruction learning')
parser.add_argument("--multiVerbalizer", default=True, action='store_true', help='for TREC')
parser.add_argument("--use_tfidf", default=False, action='store_true', help="use tfidf to generate in-contexts.")
parser.add_argument("--use_rlprompt", default=True, action='store_true', help="use hard prompt generated by rlprompt.")
